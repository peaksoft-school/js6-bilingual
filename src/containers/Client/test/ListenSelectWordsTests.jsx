    ...
    return (
        <ClientContainerTest>
            <StyledContainerListenTests>
                            ...
                            return (
                                <StyledCard key={item.id}>
                                    ...
                                    <StyledMiniContainer
                                        ...
                                        style={{
                                            background: prov.includes(item.id) && "#3a10e5",
                                        }}>
                                        <IconButtonStyled Icon={Yes} />
                                    </StyledMiniContainer>
                                </StyledCard>
                            );
                        })}
                ...
                <StyeldFooterListenTest>
                    <ButtonUi maxheight="42px" maxwidth="143px" variant="outlined">
                        NEXT
                    </ButtonUi>
                </StyeldFooterListenTest>
            </StyledContainerListenTests>
...
const StyledContainerListenTests = styled.div`
    width: 900px;
...
`;
const StyeldFooterListenTest = styled.div`
    width: 814px;
    height: 74px;
...
`;
export default ListenSelectWordsTests;
