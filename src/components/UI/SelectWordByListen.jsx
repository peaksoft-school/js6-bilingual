...
const SelectWordByListen = ({ num, selectWordByNum }) => {
    return (
        <SelectWordByMain>
            <SelectWordWrapper>
                <SelectWordRow>
                    <SelectWordLeft>
                        <SelectWordNum>{num}</SelectWordNum>
                        <SelectWordIconVolume>
                            <svg
                                width="22"
                                height="22"
                                viewBox="0 0 22 22"
                        ...
                        <SelectWordText>Word</SelectWordText>
                    </SelectWordLeft>
                    <SelectWordRight>
                        <span>
                            <CheckBox onChange={selectWordByNum} value={num} />
                        </span>
                        <span>
                            <Delete />
                        </span>
...
const SelectWordByMain = styled(motion.div)`
    max-width: 240px;
    width: 100%;
...
const SelectWordWrapper = styled.div`
    padding: 14px 16px;
    color: #4c4859;
`;

const SelectWordRow = styled.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
`;

const SelectWordLeft = styled.div`
    display: flex;
    align-items: center;
`;
const SelectWordRight = styled.div`
    display: flex;
    align-items: center;
    gap: 19.8px;
...
const SelectWordNum = styled.span`
    font-size: 16px;
    line-height: 18px;
`;
const SelectWordIconVolume = styled.span`
    margin: 0 13.26px 0 16.85px;
    display: inherit;
`;
...
export default SelectWordByListen;
